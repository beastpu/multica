...
import { Crown, Shield, User, Plus, MoreHorizontal, UserMinus, Clock, X, Mail, Link2, Copy, Check } from "lucide-react";
            ...
            <CardContent className="space-y-3">
              ...
              {inviteMode === "email" ? (
                <div className="grid gap-3 sm:grid-cols-[1fr_120px_auto]">
                  ...
                  />
                  <Select
                    items={(["member", "admin"] as const).map((value) => ({ value, label: roleConfig[value].label }))}
                    value={inviteRole}
