...
func fetchImportedSkillFromSource(ctx context.Context, httpClient *http.Client, source importSource, normalized string) (*importedSkill, error) {
	switch source {
	case sourceClawHub:
	...
	case sourceAtlasSkillHub:
		return fetchFromAtlasSkillHub(ctx, httpClient, normalized)
	default:
...
func fetchImportedSkill(rawURL string) (*importedSkill, error) {
	...
	defer cancel()
	return fetchImportedSkillFromSource(ctx, httpClient, source, normalized)
}
...
func fetchFromAtlasSkillHub(ctx context.Context, httpClient *http.Client, rawURL string) (*importedSkill, error) {
...
func (h *Handler) ImportSkill(w http.ResponseWriter, r *http.Request) {
	...
	imported, err := fetchImportedSkillFromSource(ctx, httpClient, source, normalized)
	if err != nil {
