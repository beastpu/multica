...
// The internal fork inherited upstream's historical duplicate prefixes and has
// a few Lilith-only duplicates from long-running feature branches. Freeze the
// current set so future migrations must use the next unique prefix.
var legacyDuplicateMigrationStems = map[string][]string{
	...
	"051": {"051_add_onboarding_state_to_users", "051_shareable_invitation"},
	...
	"069": {"069_comment_resolved_at", "069_drop_task_last_heartbeat", "069_runtime_visibility"},
	...
	"084": {"084_feishu_project_sync", "084_squad", "084_task_usage_dashboard_rollup"},
	"085": {"085_feishu_project_single_workspace", "085_squad_archive"},
	"086": {"086_feishu_project_sync_progress", "086_squad_avatar"},
	"091": {"091_autopilot_webhook_triggers", "091_feishu_project_owner_agent_assignment", "091_issue_start_date", "091_pr_ci_conflict"},
	...
	"108": {"108_feishu_project_business_line_routing", "108_task_token"},
	"109": {"109_agent_task_waiting_local_directory", "109_drop_agent_skills_local", "109_feishu_project_route_fallback_agent", "109_issue_pull_request_close_intent", "109_lark_integration"},
	"110": {"110_autopilot_trigger_event_filters", "110_feishu_project_attachment_binding"},
	"111": {"111_feishu_project_watermark_reconcile", "111_issue_origin_lark_chat", "111_workspace_avatar"},
	"112": {"112_feishu_project_label_sync", "112_issue_dates_to_date", "112_lark_installation_bot_union_id"},
	"113": {"113_feishu_project_orphan_reconcile", "113_lark_inbound_dedup_per_installation", "113_sys_cron_executions"},
	"114": {"114_agent_task_queue_running_started_at_index", "114_feishu_project_drop_reconcile_cadence"},
	"115": {"115_agent_runtime_last_seen_at_index", "115_feishu_project_attachment_binding_issue_key"},
	"116": {"116_lark_inbox_notification_delivery", "116_lark_installation_region"},
	"117": {"117_agent_task_queue_initiator_user_id", "117_lark_inbox_issue_card"},
	"118": {"118_agent_task_queue_initiator_user_id_drop_fk", "118_feishu_project_work_item_types"},
	"119": {"119_feishu_project_member_scope", "119_user_created_at_index"},
	"120": {"120_autopilot_subscriber", "120_comment_source_task_id", "120_github_pending_installation", "120_perforce_integration", "120_runtime_profile"},
	"121": {"121_agent_runtime_provider_partial_unique", "121_perforce_webhook_simplify"},
	"122": {"122_feishu_project_external_fields", "122_lark_chat_session_binding_thread_reply", "122_task_handoff_note"},
	...
	"128": {"128_agent_fix_p4_assessment", "128_agent_task_queue_runtime_mcp_overlay", "128_autopilot_collaborator", "128_channel_inbox_notifications", "128_comment_routing_escalation"},
	"129": {"129_agent_composio_allowlist_and_task_originator", "129_perforce_review_complete_evidence"},
	"130": {"130_agent_invocation_permission", "130_agent_task_category"},
	"131": {"131_issue_origin_slack_chat", "131_perforce_project_strategy"},
