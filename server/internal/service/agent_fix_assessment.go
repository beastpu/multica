...
func p4AssessmentHandoffNote(bindingID pgtype.UUID) string {
	...
	b.WriteString("  If it used or materially followed the AI implementation AND the AI work existed before the human submission, use \"ai_assisted\".\n")
	b.WriteString("  If it did not use the AI implementation, or the AI work was produced after delivery, use \"human_delivered\" when human ownership is proven.\n")
	b.WriteString("  If the evidence cannot prove implementation reuse, chronology, or ownership, use \"unknown\". Never infer AI assistance from method similarity alone.\n\n")
