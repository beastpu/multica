...
func TestAgentFixP4AssessmentSkillCoversReadOnlyAssessmentContract(t *testing.T) {
	...
	mustContain := []string{
		...
		"method-equivalent AI/Swarm implementation",
		"regardless of",
		"whether the AI output predates or follows the human submission",
		"Chronology is supporting context, not an exclusion rule",
		"evidence is insufficient to compare the implementations",
