...
const cancelAgentTasksByWorkflowHost = `-- name: CancelAgentTasksByWorkflowHost :many
...
const cancelAgentTasksByWorkflowInstance = `-- name: CancelAgentTasksByWorkflowInstance :many
UPDATE agent_task_queue agent_task
SET status = 'cancelled', completed_at = now(), prepare_lease_expires_at = NULL
FROM workflow_node_task node_task
WHERE agent_task.workflow_node_task_id = node_task.id
  AND node_task.workflow_instance_id = $1
  AND node_task.workspace_id = $2
  AND agent_task.status IN ('queued', 'dispatched', 'running', 'waiting_local_directory', 'deferred')
RETURNING agent_task.id, agent_task.agent_id, agent_task.issue_id, agent_task.status, agent_task.priority, agent_task.dispatched_at, agent_task.started_at, agent_task.completed_at, agent_task.result, agent_task.error, agent_task.created_at, agent_task.context, agent_task.runtime_id, agent_task.session_id, agent_task.work_dir, agent_task.trigger_comment_id, agent_task.chat_session_id, agent_task.autopilot_run_id, agent_task.attempt, agent_task.max_attempts, agent_task.parent_task_id, agent_task.failure_reason, agent_task.trigger_summary, agent_task.force_fresh_session, agent_task.is_leader_task, agent_task.wait_reason, agent_task.initiator_user_id, agent_task.handoff_note, agent_task.prepare_lease_expires_at, agent_task.squad_id, agent_task.runtime_mcp_overlay, agent_task.escalation_for_task_id, agent_task.fire_at, agent_task.originator_user_id, agent_task.runtime_connected_apps, agent_task.coalesced_comment_ids, agent_task.delivered_comment_ids, agent_task.chat_input_task_id, agent_task.chat_finalize_deferred_at, agent_task.originator_source, agent_task.delegated_from_task_id, agent_task.retry_of_task_id, agent_task.rerun_of_task_id, agent_task.rule_version_id, agent_task.trigger_evidence_kind, agent_task.trigger_evidence_ref_id, agent_task.accountable_user_id, agent_task.workflow_node_task_id, agent_task.workflow_node_instance_id
`

type CancelAgentTasksByWorkflowInstanceParams struct {
...
func (q *Queries) CancelAgentTasksByWorkflowInstance(ctx context.Context, arg CancelAgentTasksByWorkflowInstanceParams) ([]AgentTaskQueue, error) {
	rows, err := q.db.Query(ctx, cancelAgentTasksByWorkflowInstance, arg.WorkflowInstanceID, arg.WorkspaceID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
SELECT id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, initiator_user_id, handoff_note, prepare_lease_expires_at, squad_id, runtime_mcp_overlay, escalation_for_task_id, fire_at, originator_user_id, runtime_connected_apps, coalesced_comment_ids, delivered_comment_ids, chat_input_task_id, chat_finalize_deferred_at, originator_source, delegated_from_task_id, retry_of_task_id, rerun_of_task_id, rule_version_id, trigger_evidence_kind, trigger_evidence_ref_id, accountable_user_id, workflow_node_task_id, workflow_node_instance_id FROM agent_task_queue
WHERE id = $1
`
...
SELECT atq.id, atq.agent_id, atq.issue_id, atq.status, atq.priority, atq.dispatched_at, atq.started_at, atq.completed_at, atq.result, atq.error, atq.created_at, atq.context, atq.runtime_id, atq.session_id, atq.work_dir, atq.trigger_comment_id, atq.chat_session_id, atq.autopilot_run_id, atq.attempt, atq.max_attempts, atq.parent_task_id, atq.failure_reason, atq.trigger_summary, atq.force_fresh_session, atq.is_leader_task, atq.wait_reason, atq.initiator_user_id, atq.handoff_note, atq.prepare_lease_expires_at, atq.squad_id, atq.runtime_mcp_overlay, atq.escalation_for_task_id, atq.fire_at, atq.originator_user_id, atq.runtime_connected_apps, atq.coalesced_comment_ids, atq.delivered_comment_ids, atq.chat_input_task_id, atq.chat_finalize_deferred_at, atq.originator_source, atq.delegated_from_task_id, atq.retry_of_task_id, atq.rerun_of_task_id, atq.rule_version_id, atq.trigger_evidence_kind, atq.trigger_evidence_ref_id, atq.accountable_user_id, atq.workflow_node_task_id, atq.workflow_node_instance_id FROM agent_task_queue atq
...
const getLatestAgentTaskForWorkflowNodeReview = `-- name: GetLatestAgentTaskForWorkflowNodeReview :one
SELECT id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, initiator_user_id, handoff_note, prepare_lease_expires_at, squad_id, runtime_mcp_overlay, escalation_for_task_id, fire_at, originator_user_id, runtime_connected_apps, coalesced_comment_ids, delivered_comment_ids, chat_input_task_id, chat_finalize_deferred_at, originator_source, delegated_from_task_id, retry_of_task_id, rerun_of_task_id, rule_version_id, trigger_evidence_kind, trigger_evidence_ref_id, accountable_user_id, workflow_node_task_id, workflow_node_instance_id FROM agent_task_queue
...
func (q *Queries) GetLatestAgentTaskForWorkflowNodeReview(ctx context.Context, workflowNodeInstanceID pgtype.UUID) (AgentTaskQueue, error) {
	row := q.db.QueryRow(ctx, getLatestAgentTaskForWorkflowNodeReview, workflowNodeInstanceID)
	var i AgentTaskQueue
	err := row.Scan(
		&i.ID,
		&i.AgentID,
...
const getLatestAgentTaskForWorkflowNodeTask = `-- name: GetLatestAgentTaskForWorkflowNodeTask :one
SELECT id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, autopilot_run_id, attempt, max_attempts, parent_task_id, failure_reason, trigger_summary, force_fresh_session, is_leader_task, wait_reason, initiator_user_id, handoff_note, prepare_lease_expires_at, squad_id, runtime_mcp_overlay, escalation_for_task_id, fire_at, originator_user_id, runtime_connected_apps, coalesced_comment_ids, delivered_comment_ids, chat_input_task_id, chat_finalize_deferred_at, originator_source, delegated_from_task_id, retry_of_task_id, rerun_of_task_id, rule_version_id, trigger_evidence_kind, trigger_evidence_ref_id, accountable_user_id, workflow_node_task_id, workflow_node_instance_id FROM agent_task_queue
...
func (q *Queries) GetLatestAgentTaskForWorkflowNodeTask(ctx context.Context, workflowNodeTaskID pgtype.UUID) (AgentTaskQueue, error) {
	row := q.db.QueryRow(ctx, getLatestAgentTaskForWorkflowNodeTask, workflowNodeTaskID)
	var i AgentTaskQueue
	err := row.Scan(
		&i.ID,
		&i.AgentID,
...
SELECT t.id, t.agent_id, t.issue_id, t.status, t.priority, t.dispatched_at, t.started_at, t.completed_at, t.result, t.error, t.created_at, t.context, t.runtime_id, t.session_id, t.work_dir, t.trigger_comment_id, t.chat_session_id, t.autopilot_run_id, t.attempt, t.max_attempts, t.parent_task_id, t.failure_reason, t.trigger_summary, t.force_fresh_session, t.is_leader_task, t.wait_reason, t.initiator_user_id, t.handoff_note, t.prepare_lease_expires_at, t.squad_id, t.runtime_mcp_overlay, t.escalation_for_task_id, t.fire_at, t.originator_user_id, t.runtime_connected_apps, t.coalesced_comment_ids, t.delivered_comment_ids, t.chat_input_task_id, t.chat_finalize_deferred_at, t.originator_source, t.delegated_from_task_id, t.retry_of_task_id, t.rerun_of_task_id, t.rule_version_id, t.trigger_evidence_kind, t.trigger_evidence_ref_id, t.accountable_user_id, t.workflow_node_task_id, t.workflow_node_instance_id FROM (
  SELECT DISTINCT ON (atq.agent_id) atq.id, atq.agent_id, atq.issue_id, atq.status, atq.priority, atq.dispatched_at, atq.started_at, atq.completed_at, atq.result, atq.error, atq.created_at, atq.context, atq.runtime_id, atq.session_id, atq.work_dir, atq.trigger_comment_id, atq.chat_session_id, atq.autopilot_run_id, atq.attempt, atq.max_attempts, atq.parent_task_id, atq.failure_reason, atq.trigger_summary, atq.force_fresh_session, atq.is_leader_task, atq.wait_reason, atq.initiator_user_id, atq.handoff_note, atq.prepare_lease_expires_at, atq.squad_id, atq.runtime_mcp_overlay, atq.escalation_for_task_id, atq.fire_at, atq.originator_user_id, atq.runtime_connected_apps, atq.coalesced_comment_ids, atq.delivered_comment_ids, atq.chat_input_task_id, atq.chat_finalize_deferred_at, atq.originator_source, atq.delegated_from_task_id, atq.retry_of_task_id, atq.rerun_of_task_id, atq.rule_version_id, atq.trigger_evidence_kind, atq.trigger_evidence_ref_id, atq.accountable_user_id, atq.workflow_node_task_id, atq.workflow_node_instance_id
  FROM agent_task_queue atq
  JOIN agent a ON a.id = atq.agent_id
  WHERE a.workspace_id = $1
