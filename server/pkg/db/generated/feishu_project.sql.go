...
SELECT id, workspace_id, project_key, plugin_id, plugin_secret, actor_user_key, enabled, sync_story, sync_issue, mql_filter, status_mapping, reverse_status_mapping, created_by_id, last_synced_at, last_error, created_at, updated_at, business_line_field_key, business_line_field_name FROM feishu_project_integration
...
SET project_key = $3,
    ...
    updated_at = now()
WHERE id = $1 AND workspace_id = $2
RETURNING id, workspace_id, project_key, plugin_id, plugin_secret, actor_user_key, enabled, sync_story, sync_issue, mql_filter, status_mapping, reverse_status_mapping, created_by_id, last_synced_at, last_error, created_at, updated_at, business_line_field_key, business_line_field_name
`
